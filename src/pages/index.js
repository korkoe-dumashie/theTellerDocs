      ...
      <div className="container mx-auto sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <div className=" text-[24px] sm:text-[28px] md:text-4xl lg:text-5xl font-semibold mb-6 leading-tight text-[#1e1e1e] animate-fade-in">
            Accept, process and manage{" "}
            <span className="bg-gradient-to-r from-[#5188D5] to-[#0066F5] bg-clip-text text-transparent">
              payments
            </span>{" "}
            with ease
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-delay-2">
            ...
            <Link
              ...
              style={{
                ...
                minWidth: "100px",
                // height: "45px",
                padding: "12px 32px", // matches px-8 py-3
                fontWeight: "600",
                display: "inline-flex",
                alignItems: "center",
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0px 0px 20px -18px";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = "white";
                e.currentTarget.style.boxShadow = "0px 0px 20px -20px";
              }}
              onMouseDown={(e) => {
  ...
  return (
    <nav
      className={`flex justify-between items-center w-full h-20 px-10 fixed max-sm:px-5 max-sm:bg-white/70 z-20 transition-all duration-300 ${
        isScrolled
          ? " backdrop-blur-xs bg-gradient-to-r from-white/50 via-white/10 to-white/10 shadow-2xl shadow-black/5 before:absolute before:inset-0 before:bg-gradient-to-b before:from-white/20 before:to-transparent before:pointer-events-none"
          : "bg-transparent py-5"
      }`}
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a
              style={{ color: "#155DFC" }}
              href="https://payswitch.com.gh/"
              className="text-blue-600 cursor-pointer hover:underline underline-offset-6 transition-colors duration-200"
            >
              Company
            </a>
            <a
              style={{ color: "#155DFC" }}
              href="https://payswitch.com.gh/contact"
              className="text-blue-600 cursor-pointer hover:underline underline-offset-6 transition-colors duration-200"
            >
              Get Support
            </a>
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-lg py-4 px-4 absolute w-full">
          <div className="flex flex-col space-y-4">
            ...
            <a href="#" className="text-blue-600 font-medium py-2">
              Developers
            </a>
          </div>
        </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  style={{ color: "#99A1AF" }}
                  href="https://payswitch.com.gh/about"
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  About
                </a>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} PaySwitch Limited. All rights
              reserved.
            </p>
            <div className="mt-4 md:mt-0 flex flex-wrap gap-4">
              <a
                href="https://theteller.net/privacy"
                style={{ color: "#99A1AF" }}
              ...
              <a
                href="https://theteller.net/terms"
                style={{ color: "#99A1AF" }}
                className="text-gray-400 hover:text-white text-sm transition-colors"
              >
                Terms of Service
